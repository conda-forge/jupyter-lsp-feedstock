...
| [![Conda Recipe](https://img.shields.io/badge/recipe-jupyter--lsp--python--lsp--server-green.svg)](https://anaconda.org/conda-forge/jupyter-lsp-python-lsp-server) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/jupyter-lsp-python-lsp-server.svg)](https://anaconda.org/conda-forge/jupyter-lsp-python-lsp-server) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/jupyter-lsp-python-lsp-server.svg)](https://anaconda.org/conda-forge/jupyter-lsp-python-lsp-server) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/jupyter-lsp-python-lsp-server.svg)](https://anaconda.org/conda-forge/jupyter-lsp-python-lsp-server) |
...
Once the `conda-forge` channel has been enabled, `jupyter-lsp, jupyter-lsp-latex, jupyter-lsp-python, jupyter-lsp-python-lsp-server, jupyter-lsp-python-plugins, jupyter-lsp-r, jupyterlab-lsp` can be installed with:

```
conda install jupyter-lsp jupyter-lsp-latex jupyter-lsp-python jupyter-lsp-python-lsp-server jupyter-lsp-python-plugins jupyter-lsp-r jupyterlab-lsp
```
